...
import controller.ControllerListaPedidos;
...
public class ListaPedidos extends javax.swing.JFrame {
    ...
    ControllerListaPedidos controller;
    public ListaPedidos() {
        initComponents();
        iniciar();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Pedido", "ID Mesa", "Produto", "Tipo", "Quantidade", "Valor", "Status", "Observação"
            }
        ));
        ...
        jButton2.setText("Preparar pedido");

        jButton3.setText("Finalizar e entregar pedido");
    ...
    private void iniciar() {
        controller = new ControllerListaPedidos(this);
    }
}
